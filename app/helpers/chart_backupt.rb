...
module PieChartHelper
  def radial_pie_chart(pie, options = {})
    ...
    content_tag :svg, width: size, height: size, class: "radial-pie-chart", viewBox: view_box do
      ...
      (content + slices + curved_labels + divider_lines + outer_circle + javascript).html_safe
    end
  end
...
#     # if show_curved_labels
#     #   content_tag :svg, width: size, height: size, class: "radial-pie-chart", viewBox: "-10 -10 #{size + 20} #{size + 20}" do
#     # else
#     #   content_tag :svg, width: size, height: size, class: "radial-pie-chart", viewBox: "15 15 #{size - 30} #{size - 30}" do
#     # end
...
#         (content + slices + curved_labels + divider_lines + outer_circle).html_safe
#       end
#   end
